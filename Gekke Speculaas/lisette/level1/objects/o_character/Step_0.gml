...
// vertical collision
if (place_meeting(x,y+vsp,o_box_rope)) //place_meeting checks if there is a collision between two objects
{
	while (!place_meeting(x,y+sign(vsp),o_box_rope)) // ! is not
	{
		y = y + sign(vsp);
	}
	vsp = 0;
